...
/**
* Slightly modified version of this function in develop/create_schema_files.php, this version does support the $table_prefix var by it self
*
...
function get_schema_struct()
{
	...
	$schema_data[$table_prefix . 'attachments'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'acl_groups'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'acl_options'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'acl_roles'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'acl_roles_data'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'acl_users'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'banlist'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'bbcodes'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'bookmarks'] = array(
		'COLUMNS'		=> array(
			'topic_id'			=> array('UINT', 0),
			'user_id'			=> array('UINT', 0),
		),
	...
	$schema_data[$table_prefix . 'bots'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'config'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'confirm'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'disallow'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'drafts'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'extensions'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'extension_groups'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'forums'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'forums_access'] = array(
		'COLUMNS'		=> array(
			'forum_id'				=> array('UINT', 0),
			'user_id'				=> array('UINT', 0),
			'session_id'			=> array('CHAR:32', ''),
	...
	$schema_data[$table_prefix . 'forums_track'] = array(
		'COLUMNS'		=> array(
			'user_id'				=> array('UINT', 0),
			'forum_id'				=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'forums_watch'] = array(
		'COLUMNS'		=> array(
			'forum_id'				=> array('UINT', 0),
			'user_id'				=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'groups'] = array(
		'COLUMNS'		=> array(
			'group_id'				=> array('UINT', NULL, 'auto_increment'),
	...
	$schema_data[$table_prefix . 'icons'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'lang'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'log'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'moderator_cache'] = array(
		'COLUMNS'		=> array(
			'forum_id'				=> array('UINT', 0),
			'user_id'				=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'modules'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'poll_options'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'poll_votes'] = array(
		'COLUMNS'		=> array(
			'topic_id'				=> array('UINT', 0),
			'poll_option_id'		=> array('TINT:4', 0),
	...
	$schema_data[$table_prefix . 'posts'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'privmsgs'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'privmsgs_folder'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'privmsgs_rules'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'privmsgs_to'] = array(
		'COLUMNS'		=> array(
			'msg_id'				=> array('UINT', 0),
			'user_id'				=> array('UINT', 0),
			'author_id'				=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'profile_fields'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'profile_fields_data'] = array(
		'COLUMNS'		=> array(
			'user_id'				=> array('UINT', 0),
		),
		'PRIMARY_KEY'	=> 'user_id',
	...
	$schema_data[$table_prefix . 'profile_fields_lang'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'profile_lang'] = array(
		'COLUMNS'		=> array(
			'field_id'				=> array('UINT', 0),
			'lang_id'				=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'ranks'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'reports'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'reports_reasons'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'search_results'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'search_wordlist'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'search_wordmatch'] = array(
		'COLUMNS'		=> array(
			'post_id'			=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'sessions'] = array(
		'COLUMNS'		=> array(
			'session_id'			=> array('CHAR:32', ''),
	...
	$schema_data[$table_prefix . 'sessions_keys'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'sitelist'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'smilies'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'styles'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'styles_template'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'styles_template_data'] = array(
		'COLUMNS'		=> array(
			'template_id'			=> array('USINT', 0),
	...
	$schema_data[$table_prefix . 'styles_theme'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'styles_imageset'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'styles_imageset_data'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'topics'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'topics_track'] = array(
		'COLUMNS'		=> array(
			'user_id'			=> array('UINT', 0),
			'topic_id'			=> array('UINT', 0),
			'forum_id'			=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'topics_posted'] = array(
		'COLUMNS'		=> array(
			'user_id'			=> array('UINT', 0),
			'topic_id'			=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'topics_watch'] = array(
		'COLUMNS'		=> array(
			'topic_id'			=> array('UINT', 0),
			'user_id'			=> array('UINT', 0),
			'notify_status'		=> array('BOOL', 0),
	...
	$schema_data[$table_prefix . 'user_group'] = array(
		'COLUMNS'		=> array(
			'group_id'			=> array('UINT', 0),
			'user_id'			=> array('UINT', 0),
	...
	$schema_data[$table_prefix . 'users'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'warnings'] = array(
		'COLUMNS'		=> array(
	...
	$schema_data[$table_prefix . 'words'] = array(
		'COLUMNS'		=> array(
			'word_id'				=> array('UINT', NULL, 'auto_increment'),
	...
	$schema_data[$table_prefix . 'zebra'] = array(
		'COLUMNS'		=> array(
			'user_id'				=> array('UINT', 0),
...
/**
* All the bots that come with a vanilla phpBB3.0.x installation
*
* @return	array	A list with all the supported bots
*/
...
/**
* Config fields that have to be backed up before restoring the config table
* this are values that doens't exist or don't have a value in the schema, and
* thus causeing problems!
*
* @return	array	A list with all the config entries that have to be saved before truncating the table
*/
function get_save_config_list()
{
	return array(
		'board_startdate'		=> false,
		'default_lang'			=> false,
		'img_imagick'			=> false,
		'server_name'			=> false,
		'server_port'			=> false,
		...
		'board_contact'			=> false,
		'cookie_domain'			=> false,
		'default_dateformat'	=> false,
		'email_enable'			=> false,
		'smtp_delivery'			=> false,
		'smtp_host'				=> false,
		'smtp_auth_method'		=> false,
		'smtp_username'			=> false,
		'smtp_password'			=> false,
		'cookie_secure'			=> false,
		...
		'num_users'				=> true,
		'rand_seed'				=> true,
		'rand_seed_last_update'	=> true,
		'record_online_date'	=> true,
		'record_online_users'	=> true,
		'search_last_gc'		=> true,
		'session_last_gc'		=> true,
		'upload_dir_size'		=> true,
		'warnings_last_gc'		=> true,
	);
}
?>