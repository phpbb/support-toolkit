...
/**
*
* @package Support Toolkit - Make Founder [Deutsch — Sie]
...
$lang = array_merge($lang, array(
	...
	'MAKE_FOUNDER_CONFIRM'		=> 'Sind Sie sicher, dass Sie <a href="%1$s">%2$s</a> zum Gründer ernennen wollen? Dies gibt <a href="%1$s">%2$s</a> neben anderen Rechten die Möglichkeit, Ihr Benutzerkonto zu löschen.',
	...
	'USER_NAME_TO_FOUNDER_EXPLAIN'	=> 'Geben Sie den Benutzernamen des Benutzers an, der zum Gründer ernannt werden soll.',
	'USER_ID_TO_FOUNDER'			=> 'ID des zum Gründer zu ernennenden Benutzers',
	'USER_ID_TO_FOUNDER_EXPLAIN'	=> 'Geben Sie die ID des Benutzers an, der zum Gründer ernannt werden soll.',
));
