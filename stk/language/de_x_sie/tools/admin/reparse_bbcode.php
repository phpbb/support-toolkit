...
/**
*
* @package Support Toolkit - Reparse BBCode [Deutsch — Sie]
...
$lang = array_merge($lang, array(
	...
	'REPARSE_BBCODE_CONFIRM'	=> 'Sind Sie sicher, dass Sie alle BBCodes neu verarbeiten wollen? Beachten Sie, dass dieses Tool Ihre Datenbank auch beschädigen kann. <strong>Sichern Sie daher Ihre Datenbank, bevor Sie fortfahren.</strong> Beachten Sie bitte auch, dass dieses Tool einige Zeit zur Ausführung benötigen kann.',
	...
	'REPARSE_IDS_INVALID'			=> 'Die angegebenen IDs waren ungültig. Bitte stellen Sie sicher, dass die IDs als kommagetrennte Liste (z.&nbsp;B. 1,2,3,5,8,13) angegeben werden.',
	'REPARSE_POST_IDS'				=> 'Spezifische Beiträge neu verarbeiten',
	'REPARSE_POST_IDS_EXPLAIN'		=> 'Um nur bestimmte Beiträge neu zu verarbeiten, geben Sie die IDs der Beiträge als kommagetrennte Liste an (z.&nbsp;B. 1,2,3,5,8,13).',
	'REPARSE_PM_IDS'				=> 'Spezifische Private Nachrichten neu verarbeiten',
	'REPARSE_PM_IDS_EXPLAIN'		=> 'Um nur bestimmte Private Nachrichten neu zu verarbeiten, geben Sie die IDs der Privaten Nachrichten als kommagetrennte Liste an (z.&nbsp;B. 1,2,3,5,8,13).',
));
