...
//	'STEP1_CONVERT_EXPLAIN'	=> '',
	...
	'STEP1_MOD_ERROR'		=> 'Support Fragen für MOD spezifische Probleme (z.B., wenn du gerade einen MOD installiert hast und nun Fehler bekommst) sollten dort in das Thema gestellt werden, wo du den MOD runtergeladen hast. Wenn du den MOD von einer anderen Seite (als phpBB.com) musst du dort nach Support suchen.<br /><br /><a href="http://www.phpbb.com/community/viewforum.php?f=81">Gehen zu den MOD Foren</a>',
	...
	'STEP1_HACKED_ERROR'	=> 'Wenn dein Board gehackt wurde, bitten wir dich deinen Report im "Incident Investigation Tracker" einzustellen und nicht im Support Forum, damit keine privaten Daten öffentlich angezeigt werden.<br /><br />Siehe in diesem <a href="http://www.phpbb.com/community/viewtopic.php?f=46&t=543171#iit">Beitrag</a>.',
));
...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS'			=> array(
		'step2'	=> array(
			'phpbb_version'		=> 'Welche Version von phpBB nutzt du?',
			'board_url'			=> 'Wie ist die URL zu deinem Board?',
			'dbms'				=> 'Welchen Datenbanktyp und -version nutzt du?',
			'php'				=> 'Welche PHP-Version nutzt du?',
			'host_name'			=> 'Mit was hostest du dein Board?',
...
$lang = array_merge($lang, array(
	'SRT_QUESTIONS_EXPLAIN'	=> array(
		'step2'	=> array(
			...
			'board_url'			=> 'Deine Board URL ist die Adresse, die du nutzt um dein Board aufzurufen. Die meisten Problem lassen sich einfacher lösen, wenn man das Board besuchen kann. Wenn du uns diese Information nicht geben willst, gib "n/a" ein.',
