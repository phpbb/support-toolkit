...
/**
*
* @package Support Toolkit - Orphaned Posts [Deutsch — Du]
...
$lang = array_merge($lang, array(
	...
	'ORPHANED_POSTS_EXPLAIN'	=> 'Den folgenden Beiträgen sind keine Themen zugeordnet. Gib eine neue Themen-ID ein, um diese Beiträge mit dem Thema zu verbinden.',
	'NO_ORPHANED_POSTS'			=> 'Keine verwaisten Beiträge gefunden',
	'NO_TOPIC_IDS'				=> 'Keine Themen-ID angegeben',
	'NONEXISTENT_TOPIC_IDS'		=> 'Die folgenden Ziel-Themen-IDs existieren nicht: %s.<br />Bitte überprüfe die angegeben Themen-IDs.',
	'REASSIGN'					=> 'Neu zuordnen',

	'DELETE_SHADOWS'			=> 'Per Klick werden alle ausgewählten verwaisten Links gelöscht. (Dieser Schritt kann nicht rückgängig gemacht werden!)',
