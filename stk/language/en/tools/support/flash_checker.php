...
$lang = array_merge($lang, array(
	...
	'FLASH_CHECKER_CONFIRM'		=> 'In phpBB 3.0.7-pl1 a possible XSS vulnerability was found in the buildin flash BBCode. This issue was resolved in phpBB 3.0.8, this tool will check all posts, pms and signatures for this vulnerable BBCode. If found it allows you to quickly reparse these posts to make sure that your board is save. Click <a href="#">here</a> for more information about the issue.',
