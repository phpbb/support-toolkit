...
$lang = array_merge($lang, array(
	...
	'SECTION_NOT_CHANGED_TITLE'		=> array(
		...
		4	=> 'Extension groups not changed',
		5	=> 'Extensions not changed',
		6	=> 'Permissions not changed',
		7	=> 'Groups not changed',
		8	=> 'Roles not changed',
		12	=> 'Final step',
	),
	'SECTION_NOT_CHANGED_EXPLAIN'	=> array(
		...
		4	=> 'The extension groups table doesn’t have any new/missing values',
		5	=> 'The default extensions haven\'t changed',
		6	=> 'There where no changes in the permission tables',
		7	=> 'There where no changes in the phpBB system groups',
		8	=> 'There where no roles added or removed',
		12	=> 'This last step will clear the cache and re-enable the board.',
	),
	'SUCCESS'						=> 'Success',
