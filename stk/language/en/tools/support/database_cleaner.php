...
$lang = array_merge($lang, array(
	...
	'SECTION_NOT_CHANGED_TITLE'		=> array(
		...
		5	=> 'Permissions not changed',
		6	=> 'Groups not changed',
		7	=> 'Roles not changed',
		11	=> 'Final step',
	),
	'SECTION_NOT_CHANGED_EXPLAIN'	=> array(
		...
		5	=> 'There where no changes in the permission tables',
		6	=> 'There where no changes in the phpBB system groups',
		7	=> 'There where no roles added or removed',
		11	=> 'This last step will clear the cache and re-enable the board.',
	),
	'SUCCESS'						=> 'Success',
