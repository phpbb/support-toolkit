...
$lang = array_merge($lang, array(
	...
	'MERGE_USERS_EXPLAIN'				=> 'このツールではユーザーのアカウントを他のユーザーのアカウントに マージ（合併・吸収） できます。マージ元ユーザーからマージ先ユーザーへ、ユーザー設定とグループメンバーシップはコピーされ、ユーザーパーミッション、添付ファイル、アクセス禁止、ブックマーク、下書き、フォーラムとトピックの既読、フォーラムとトピックのウォッチ、ログ、投票、投稿記事、PM、通報、トピック、警告、フレンドリストとブロックリスト、は追加されます。',
