...
$lang = array_merge($lang, array(
	...
	'MERGE_USERS_USER_SOURCE'			=> 'Usuário de origem',
	'MERGE_USERS_USER_SOURCE_EXPLAIN'	=> 'Mensagens, mensagens privadas, permissões, advertências, etc. serão movidos deste usuário para o usuário de destino, são copiadas configurações de usuário e membros do grupo.',

	'MERGE_USERS_USER_TARGET'	=> 'Usuário de destino',
));
