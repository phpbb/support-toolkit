...
$lang = array_merge($lang, array(
	...
	'SRT_GENERATOR'					=> 'Generator szablonu prośby o pomoc',
	'SRT_GENERATOR_LANDING'			=> 'Generator szablonu prośby o pomoc',
	'SRT_GENERATOR_LANDING_CONFIRM'	=> 'Witaj w Generatorze szablonu prośby o pomoc do zespołu zajmującego się wsparciem. Jest to najszybszy i najbardziej efektywny sposób uzupełnienia naszego szablonu prośby o pomoc. Generator zada Ci od ośmiu do dziesięciu pytań które pomagają w rozwiązywaniu większości problemów. It will then compile your answers into a list that may be copied and pasted into your support topic.<br />This STK tool does the same thing as the <a href="http://www.phpbb.com/support/stk/">SRT Generator on www.phpbb.com</a> but attempts to pre-fill certain questions.<br /><br />Do you wish run the SRT Generator?',
...
//	'STEP1_CONVERT_EXPLAIN'	=> '',
	'STEP1_MOD'				=> 'Czy Twój problem jest związany z zainstalowaną modyfikacją?',
