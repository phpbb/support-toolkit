...
$lang = array_merge($lang, array(
	...
	'INCORRECT_CLASS'					=> 'Classe incorreta: stk/tools/%1$s.%2$s',
	...
	'STK_OUTDATED'						=> 'A sua instalação do STK parece estar desatualizada. A última versão é : <strong style="color: #008000;">%1$s</strong>, a versão instalada é <strong style="color: #FF0000;">%2$s</strong>.<br /><br />Devido ao grande impacto que esta ferramenta tem sobre a sua instalação do phpBB ela foi desativada até que seja feita a atualização. Recomendamos que tenha sempre o software atualizado. Para mais informações sobre a atualização mais recente, consulte a <a href="%3$s">página do stk</a>.',
