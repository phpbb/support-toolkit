...
+   'REQUEST_PHPBB_VERSION_EXPLAIN'		=> 'De Support Toolkit (STK) kon jouw phpBB versie niet achterhalen, selecteer de juiste versie voordat je verder gaat.<br />Dit kan betekenen dat jouw forumbestanden en forumversie inconsistent zijn, waarschijnlijk door een niet succesvol afgemaakte update. Bezoek de <a href="https://www.phpbb.com/community/viewforum.php?f=46">support forums</a> om hulp te krijgen om dit probleem op te lossen.',
