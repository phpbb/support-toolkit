...
/**
* phpBB 3.0.11 data file
*/
class datafile_3_0_11
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No bot changes 3.0.10 -> 3.0.11
	);

	/**
	* @var Array 3.0.10 config data
	*/
	var $config = array(
		// No config changes 3.0.10 -> 3.0.11
	);

	/**
	* @var Array Config entries that were removed by the 3.0.10 update
	*/
	var $removed_config = array(
		// No config entries removed 3.0.10 -> 3.0.11
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.0.10 -> 3.0.11
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.0.10 -> 3.0.11
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.0.10 -> 3.0.11
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.0.10 -> 3.0.11
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes 3.0.10 -> 3.0.11
	);
	var $module_extras = array(
		// No Module extra changes 3.0.10 -> 3.0.11
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.0.10 -> 3.0.11
	);
	...
	*/
	var $report_reasons = array(
		// No reason changes 3.0.10 -> 3.0.11
	);
