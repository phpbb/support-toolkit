...
/**
* phpBB 3.0.10 data file
*/
class datafile_3_0_10_RC2
{
	/**
	* @var Array The bots
	*/
	var $bots = array(
		// No bot changes 3.0.9 -> 3.0.10
	);
	...
	*/
	var $removed_config = array(
		// No config entries removed 3.0.9 -> 3.0.10
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.0.9 -> 3.0.10
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.0.9 -> 3.0.10
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.0.9 -> 3.0.10
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.0.9 -> 3.0.10
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes 3.0.9 -> 3.0.10
	);
	var $module_extras = array(
		// No Module extra changes 3.0.9 -> 3.0.10
	);
	...
	*/
	var $report_reasons = array(
		// No reason changes 3.0.9 -> 3.0.10
	);
	...
	*/
	...
	{
		// No schema changes 3.0.9 -> 3.0.10
	}
}
