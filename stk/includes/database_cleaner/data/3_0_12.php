...
/**
* phpBB 3.0.12 data file
*/
class datafile_3_0_12
{
	/**
	* @var Array The bots
	*/
	...
	*/
	var $config = array(
		// No config changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $removed_config = array(
		// No config entries removed 3.0.11 -> 3.0.12
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes 3.0.11 -> 3.0.12
	);
	var $module_extras = array(
		// No Module extra changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.0.11 -> 3.0.12
	);
	...
	*/
	var $report_reasons = array(
		// No reason changes 3.0.11 -> 3.0.12
	);
	...
	*/
	...
	{
		// No schema changes 3.0.11 -> 3.0.12
	}
}
