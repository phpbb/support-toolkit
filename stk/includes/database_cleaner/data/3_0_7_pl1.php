...
class datafile_3_0_7_pl1
{
	...
	*/
	var $bots = array(
		// No bot changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $acl_roles = array(
		// No role changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.0.7 -> 3.0.7-pl1
	);
	...
	*/
	var $report_reasons = array(
		// No reason changes 3.0.7 -> 3.0.7-pl1
	);
